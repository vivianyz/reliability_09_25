...
# Reliability round 09_25: ANNOTATOR_ID comes from Streamlit secrets so one
# branch/folder serves every annotator (set ANNOTATOR_ID = "002" etc. per app).
ANNOTATOR_ID = str(st.secrets.get("ANNOTATOR_ID", "")).strip().zfill(3)
if ANNOTATOR_ID == "000":
    st.error("ANNOTATOR_ID is missing from secrets. Add ANNOTATOR_ID = \"00X\" and reboot the app.")
    st.stop()
